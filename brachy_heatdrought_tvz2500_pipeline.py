...
def main():
    ...
    masked1, binary, contours, hierarchy = pcv.rectangle_mask(img=masked, p1=(1720,750), p2=(1765,955), color="black")
    ...
    if args.coresult is not None:
        ...
        newmask = pcv.crop_position_mask(img=nir, mask=nmask, x=16, y=6, v_pos="bottom", h_pos="left")
