...
def main():
    ...
    s_thresh = pcv.threshold.binary(gray_img=s, threshold=33, max_value=255, object_type='light')
    ...
    roi_contour, roi_hierarchy= pcv.roi.rectangle(img=img_wb, x=850, y=500, h=670, w=700)
    ...
    nbmask = pcv.naive_bayes_classifier(masked, "brachy_naive_bayes_pdfs.txt")
    ...
    if args.coresult is not None:
        ...
        newmask = pcv.crop_position_mask(img=nir, mask=nmask, x=70, y=0, v_pos="top", h_pos="left")
