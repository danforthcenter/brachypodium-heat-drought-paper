...
def main():
    ...
    masked1, binary, contours, hierarchy = pcv.rectangle_mask(img=masked, p1=(1930,760), p2=(2000,830), color="black")
    ...
    if args.coresult is not None:
        ...
        newmask = pcv.crop_position_mask(img=nir, mask=nmask, x=17, y=18, v_pos="bottom", h_pos="left")
