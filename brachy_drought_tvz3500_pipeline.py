...
def main():
    ...
    roi_contour, roi_hierarchy= pcv.roi.rectangle(img=img_wb, x=700, y=600, h=1000, w=1000)
    ...
    masked1, binary, contours, hierarchy = pcv.rectangle_mask(img=masked, p1=(1900,720), p2=(2200,850), color="black")
    ...
    if args.coresult is not None:
        ...
        newmask = pcv.crop_position_mask(img=nir, mask=nmask, x=18, y=21, v_pos="bottom", h_pos="left")
