...
def main():
    ...
    roi_contour, roi_hierarchy= pcv.roi.rectangle(img=img_wb, x=650, y=400, h=850, w=1150)
    ...
    height_img = pcv.analyze_bound_horizontal(img=img_wb, obj=obj, mask=mask, line_position=1110)
    ...
    masked1, binary, contours, hierarchy = pcv.rectangle_mask(img=masked, p1=(0,0), p2=(275,2055), color="black")

    masked2, binary, contours, hierarchy = pcv.rectangle_mask(img=masked1, p1=(2200,0), p2=(2500,2055), color="black")   
    
    masked3, binary, contours, hierarchy = pcv.rectangle_mask(img=masked2, p1=(0,1520), p2=(2500,2055), color="black")
    ...
    if args.coresult is not None:
        ...
        newmask = pcv.crop_position_mask(img=nir, mask=nmask, x=34, y=0, v_pos="top", h_pos="left")
