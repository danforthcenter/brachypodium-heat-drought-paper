...
def main():
    ...
    height_img = pcv.analyze_bound_horizontal(img=img_wb, obj=obj, mask=mask, line_position=1170)
    ...
    masked2, binary, contours, hierarchy = pcv.rectangle_mask(img=masked1, p1=(1485,1400), p2=(1500,1520), color="black")
    ...
    if args.coresult is not None:
        ...
        newmask = pcv.crop_position_mask(img=nir, mask=nmask, x=48, y=4, v_pos="top", h_pos="left")
